...
const formFieldClassName =
  "w-full min-h-[3.25rem] rounded-2xl border border-white/15 bg-black/30 px-4 py-3 text-[16px] text-white placeholder:text-white/40 outline-none transition-all focus:border-[#FFD700] focus:ring-2 focus:ring-[#FFD700]/45";
...
const HeroTicketPopup = ({ startTimer }: { startTimer: boolean }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] overflow-y-auto bg-black/75 p-3 backdrop-blur-md sm:flex sm:items-center sm:justify-center sm:p-4">
      <div className="relative my-auto w-full max-w-5xl overflow-hidden rounded-[1.5rem] border border-white/15 bg-[#031b24]/95 shadow-[0_30px_80px_rgba(0,0,0,0.45)] sm:rounded-[2rem]">
        ...
        <div className="relative z-10 max-h-[calc(100dvh-1.5rem)] overflow-y-auto overscroll-contain sm:max-h-[90dvh]">
          <div className="sticky top-0 z-20 flex justify-end px-3 pt-3 sm:px-4 sm:pt-4">
            <button
              type="button"
              onClick={closePopup}
              aria-label="Close ticket popup"
              className="rounded-full border border-white/10 bg-[#031b24]/85 p-2 text-white shadow-lg transition-colors hover:bg-white/20"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="border-b border-white/10 px-5 pb-5 pt-2 sm:px-7 sm:pb-7 sm:pt-3 lg:border-b-0 lg:border-r lg:p-10">
              <p className="mb-3 text-xs font-black uppercase tracking-[0.3em] text-[#F8D76E] sm:text-sm sm:tracking-[0.35em]">
                Limited Seats
              </p>
              <h3
                className="mb-4 max-w-md text-3xl font-extrabold leading-tight text-[#FFD700] font-serif sm:mb-5 sm:text-4xl md:text-5xl"
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/8 p-3.5 sm:p-4">
                ...
                <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/8 p-3.5 sm:p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-5 text-white/70 sm:leading-6">
                      Includes event type, date, ticket count, and special
                      notes.
                    </p>
                  </div>
                </div>
            ...
            <div className="px-5 pb-5 pt-4 sm:px-7 sm:pb-7 lg:p-10">
              <form className="space-y-4 sm:space-y-5" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5">
                  <div>
                    <label className="mb-2 block text-xs font-bold uppercase tracking-wide text-white/85 sm:text-sm">
                      First Name
                    </label>
                    <input
                      type="text"
                ...
                <div className="flex flex-col gap-3 pt-1 sm:flex-row sm:pt-2">
                  <button
                    type="submit"
                    disabled={loading}
                    className="inline-flex w-full flex-1 items-center justify-center rounded-full bg-[#F424B2] px-6 py-4 text-base font-extrabold text-white shadow-[0_6px_0_#9e1773] transition-all duration-300 hover:translate-y-1 hover:bg-[#d91a9b] hover:shadow-[0_4px_0_#9e1773] disabled:cursor-not-allowed disabled:opacity-70"
                  >
                  ...
                  <button
                    type="button"
                    onClick={closePopup}
                    className="inline-flex w-full items-center justify-center rounded-full border border-white/15 bg-white/10 px-6 py-4 text-base font-bold text-white transition-colors hover:bg-white/15 sm:w-auto"
                  >
                    Maybe later
                  </button>
                </div>
